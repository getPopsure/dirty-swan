    ...
    <div>
      {values.map((value) => (
        <div key={value}>
          ...
          >
            <div
              className={`ds-neutral-50 p16 m8 d-flex ai-center jc-center ${style.item}`}
            >
              1
            </div>
            <div
    ...
    <div>
      {values.map((value) => (
        <div key={value}>
          ...
          >
            <div className={`ds-neutral-50 p16  m8 ${style.item}`}>Item</div>
            <div
              className={`ds-neutral-50 p16 m8 d-flex ai-center ${style.item} ${style['ai-item-2']}`}
            >
              Item
            </div>
            <div
              className={`ds-neutral-50 p16 m8 ${style.item} ${
                style[['ai-item-3']]
              }`}
            >
              Item
