...
const story = {
  ...
  argTypes: {
    ...
    children: {
      control: 'text',
      description:
        'Content that is displayed inside the card under the pre-defined props',
    },
    onClick: {
      action: true,
      table: {
    ...
    actionIcon: {
      control: 'text',
      description:
        'ReactNode to be rendered on the right side of the card when there is an onClick action. By default it renders the ChevronRightIcon.',
    },
    showActionIcon: {
      description:
        'Property that always displays action icon even if no onClick is set.',
    },
    verticalAlignment: {
  ...
  args: {
    density: 'medium',
    description:
      'Believe you’re a great fit but can’t find a position listed for your skill set? We’d love to hear from you!',
...
export const CardVariants = {
  render: ({ description, onClick, title }: CardProps) => (
...
export const CardAsOtherComponents = () => (
  <div className="d-flex fd-column gap16 p24 bg-neutral-100">
    ...
    <Card as="nav" title="Card with a nav tag" density="xsmall" />
...
export const CardDensities = () => (
  <div className="d-flex fd-column gap16 p24 bg-neutral-100">
    <Card title={'Card density: xsmall'} density="xsmall" />
    <Card title={'Card density: small'} density="small" />
    <Card title={'Card density: medium'} density="medium" />
    <Card title={'Card density: large'} density="large" />
  </div>
);

export const CardsWithIcons = {
  render: ({ title }: CardProps) => (
    <div className="d-flex gap16 p24 bg-neutral-100">
      <Card
        icon={<img alt="" src={illustrations.aids} width={24} />}
        title={title}
      />
      <Card icon={<MehIcon size={24} noMargin />} title={title} />
    </div>
  ),
};

export const CardWithOnClickAction = {
  render: ({ children, title }: CardProps) => (
    <div className="d-flex p24 bg-neutral-100">
      <Card
        icon={<img alt="" src={illustrations.aids} width={24} />}
        title={title}
...
export const CardOverridesStyles = {
  render: ({ children, label, title }: CardProps) => (
    <div className="d-flex p24 bg-neutral-100">
      <Card
        label={label}
        title={title}
    ...
    <Card
      ...
      title={
        <div className="d-flex jc-between ai-center w100">
          Coverage overview
          <Button as="a" href="#" onClick={console.log}>
