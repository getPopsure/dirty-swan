...
const story = {
  ...
  argTypes: {
    suggestions: {
      description:
        'List of suggestions that should be displayed to the respective input',
    },
    currentOption: {
    ...
    handleSuggestionSelected: {
      description:
        'Function that runs when a suggestion is selected from the dropdown',
      action: true,
      table: {
        category: 'Callbacks',
      },
    ...
    handleSuggestionFetchRequest: {
      description:
        'Function that allows control of which suggestions should be displayed',
      action: true,
      table: {
        category: 'Callbacks',
      },
    ...
    handleSuggestionClearRequest: {
      description:
        'Function that runs when suggestions are cleared (eg. input removal, selecting suggestion)',
      action: true,
      table: {
        category: 'Callbacks',
      },
