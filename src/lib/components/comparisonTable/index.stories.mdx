...
| minCellWidth          | number              | Minimum width of a table content cell                      | 256px         | false    |
| maxFirstColumnWidth   | number              | Maximum width of the first column of the table             | 288px         | false    |
