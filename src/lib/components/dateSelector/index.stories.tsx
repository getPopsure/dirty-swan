...
const story = {
  ...
  argTypes: {
    ...
    onChange: {
      description:
        'Called when the value is changed. Must be a valid date to be triggered',
      action: true,
      table: {
        category: 'Callbacks',
        type: {
    ...
    placeholders: {
      description:
        'Properties used to localize the calendar of the DateSelector. `placeholders` object can be used to change the text of the different dropdowns.',
    },
    firstDayOfWeek: {
...
export const DateSelectorLocalisation = {
  render: ({ onChange, value, yearBoundaries }: DateSelectorProps) => (
    <>
      {/** import de from 'dayjs/locale/de'; */}
      <DateSelector
        value={value}
